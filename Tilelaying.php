    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            <h2>Providing Tile Laying Services</h2>
            <div class="our-story">
              <h4></h4>
              <h3>Our Story</h3>
              <p>Transform your spaces with Shanmugam Associates' expert tile laying services. Our dedication to craftsmanship, attention to detail, and commitment to quality ensure that your tile installation project exceeds expectations.</p>
              <ul>
                <li><i class="bi bi-check-circle"></i> <span>Elevate the look of your home with our residential tile laying services. Whether it's a kitchen backsplash, bathroom renovation, or flooring upgrade, our team ensures flawless and stylish tile installations.</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Our team collaborates with clients to create bespoke patterns and layouts, turning your vision into a personalized work of art. </span></li>
                <li><i class="bi bi-check-circle"></i> <span>Enhance both functionality and aesthetics with our floor and wall tiling services. We work with a variety of tile materials, sizes, and styles to achieve the perfect look for any space.</span></li>
              </ul>

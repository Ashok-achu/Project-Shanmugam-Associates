...
<head>
  ...
  <title>Shanmugam Associates - Villa</title>
...
<body>
  ...
  <header id="header" class="header d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <?php // Start the session on all pages where you want to use this variable
session_start();
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            <h2>Providing Villa Services</h2>
            <div class="our-story">
              <h4></h4>
              <h3>Our Story</h3>
              <p>Welcome to Shanmugam Associates, where we turn dreams of sophisticated living into reality. Our Villa designs embody elegance, comfort, and the epitome of modern luxury. Each villa is a masterpiece, meticulously crafted to cater to the unique preferences and lifestyles of our clients.</p>
              <ul>
                <li><i class="bi bi-check-circle"></i> <span>Our villas boast architectural brilliance that seamlessly blends aesthetics with functionality. Every detail is carefully considered to create a harmonious living space.</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Your villa, your style. We offer a range of customization options, allowing you to personalize your living space according to your taste and preferences. Our team works closely with you to bring your vision to life. </span></li>
                <li><i class="bi bi-check-circle"></i> <span>Enjoy the serenity of your private retreat. Our villas often feature secluded gardens, courtyards, or private pools, providing an oasis of tranquility right at your doorstep.</span></li>
              </ul>

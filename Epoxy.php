...
<head>
  ...
  <title>Shanmugam Associates - Epoxy</title>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            <h2>Providing Epoxy Services</h2>
            <div class="our-story">
              <h4></h4>
              <h3>Our Story</h3>
              <p>Elevate your spaces with the modern aesthetic and durability of epoxy flooring from Shanmugam Associates. Our epoxy services redefine the concept of flooring, bringing together style and strength.</p>
              <ul>
                <li><i class="bi bi-check-circle"></i> <span> From vibrant living spaces to high-traffic areas, our residential epoxy solutions combine style with practicality.</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Impress clients and customers with professionally installed epoxy flooring in your commercial space. </span></li>
                <li><i class="bi bi-check-circle"></i> <span> Our team understands the unique challenges of heavy machinery and high-traffic areas, delivering reliable and resilient flooring.</span></li>
              </ul>

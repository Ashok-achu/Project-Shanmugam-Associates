...
<head>
  ...
  <title>Shanmugam Associates - About</title>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            <h2>About Shanmugam Associates</h2>
            <div class="our-story">
              <h4></h4>
              <h3>Our Story</h3>
              <p>Established in [year of establishment], Shanmugam Associates has evolved into a dynamic force within the [industry] landscape. Our journey began with a passion for [mention any unique aspect of your business or your founders' vision] and a dedication to providing top-notch services that make a meaningful impact.</p>
              <ul>
                <li><i class="bi bi-check-circle"></i> <span>Our team comprises seasoned professionals with a wealth of experience in industry.</span></li>
                <li><i class="bi bi-check-circle"></i> <span>We believe in building lasting relationships with our clients. </span></li>
                <li><i class="bi bi-check-circle"></i> <span>Understanding their unique needs allows us to tailor solutions that exceed expectations.</span></li>
              </ul>

...
<head>
  ...
  <title>Shanmugam Associates - Painting</title>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            <h2>Providing Painting Services</h2>
            <div class="our-story">
              <h4></h4>
              <h3>Our Story</h3>
              <p>At Shanmugam Associates, we understand the transformative power of paint. Our painting services go beyond just applying color; we create atmospheres, enhance aesthetics, and bring your vision to life. </p>
              <ul>
                <li><i class="bi bi-check-circle"></i> <span>Elevate the ambiance of your interiors with our expert interior painting services. We focus on precision, using high-quality paints to create seamless and lasting finishes.</span></li>
                <li><i class="bi bi-check-circle"></i> <span>Protect and enhance the curb appeal of your property with our exterior painting expertise. </span></li>
                <li><i class="bi bi-check-circle"></i> <span>Ensure the durability and safety of industrial structures with our specialized industrial painting services.</span></li>
              </ul>

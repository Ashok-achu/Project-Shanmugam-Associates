...
<head>
  ...
  <title>Shanmugam Associates - Project Details</title>
    ...
    <section id="projects" class="projects">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
         ...
         <!-- Display uploaded images with their titles -->
...
.portfolio-content img {
  width: 100%;
  height: 270px; /* Set a fixed height for uniform display */
...
<?php
    ...
    $jsonFile = 'project_images.json'; // JSON file storing image details
  ...
  foreach ($imageDetails as $image) {
      ...
      echo '<img src="' . $image['image_path'] . '" alt="' . $image['project_title'] . '">';

      echo '<div class="portfolio-info">';
      echo '<h4>' . $image['project_title'] . '</h4>';
      echo '</div>'; // Close portfolio-info

      echo '</div>'; // Close portfolio-content
  }
  ?>
  </div>
...
if (isset($_SESSION['admin'])) {
    ...
    ?>
    <div>
    <form action="uploadprojects.php" method="post">
        <button type="submit" name="add_images">Add Images</button>
</form>
</div>
<br><br>

<form action="delete_image.php" method="post">
    <select name="image_title">
        <option value="" disabled selected>Select an image to delete</option>
        <?php foreach ($imageDetails as $image) : ?>
            <option value="<?php echo $image['project_title']; ?>">
                <?php echo $image['project_title']; ?>
            </option>
        <?php endforeach; ?>
    </select>
    <br><br>
    <div><button type="submit" name="delete_image">Delete Image</button></div>
</form>
